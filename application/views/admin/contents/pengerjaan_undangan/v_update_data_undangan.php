		...
		<div class="card shadow px-3">
				...
				<div class="form-group mb-3">
					...
					<div class="input-group">
						...
						<div class="custom-file">
							<input type="file" name="cover_img_update[1]" class="custom-file-input <?= (form_error('cover_img_update[1]')) ? 'is-invalid' : '' ?>" id="uploadSampul" accept="image/*">
							<label class="custom-file-label" for="uploadSampul">Choose file</label>
							<div class="invalid-feedback"><?= form_error('cover_img_update[1]') ?></div>
						</div>
					</div>
			...
			<div class="form-group mb-3">
				...
				<div class="input-group">
					...
					<div class="custom-file">
						<input type="file" name="cover_img_update[2]" class="custom-file-input <?= (form_error('cover_img_update[2]')) ? 'is-invalid' : '' ?>" id="uploadCover" accept="image/*">
						<label class="custom-file-label" for="uploadCover">Choose file</label>
						<div class="invalid-feedback"><?= form_error('cover_img_update[2]') ?></div>
					</div>
				</div>
				<p>Catatan: File max 2mb format (SVG,PNG,JPG,JPEG), rekomendasi format SVG (270 x 378 pixels) </p>
			</div>
