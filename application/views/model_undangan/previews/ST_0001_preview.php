...
<head>
	...
	<!--Style CSS-->
	<link rel="stylesheet" href="<?= base_url() ?>assets/sp_0001/css/style_.css">
	<!--Lightbox CSS-->
	<link rel="stylesheet" href="<?= base_url() ?>assets/sp_0001/vendor/lightbox.css">
	<!--CCS ANIMATE-->
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css">
	<!--AOS-->
	<link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
	<!--Icon Tittle -->
	<link rel="icon" href="<?= base_url() ?>assets/sp_0001/icon/ic-ms.png">
</head>
...
<body>
	...
	<div class="sampul" id="sampul">
		<section class="group3">
			<img src="<?= base_url() ?>assets/sp_0001/image/sampul/group3.svg" alt="group3">
		</section>

		<section class="group4">
			<img src="<?= base_url() ?>assets/sp_0001/image/sampul/group4.svg" alt="group4">
		</section>

		<!--Responsive Bingkai For Tablets-->
		<section class="group1">
			<img src="<?= base_url() ?>assets/sp_0001/image/sampul/group1.svg" alt="group1">
		</section>

		<section class="group2">
			<img src="<?= base_url() ?>assets/sp_0001/image/sampul/group2.svg" alt="group2">
		</section>
		<!--/Responsive Bingkai For Tablets -->

		<!--Responsive Bingkai For Apple Smartphone & Android Smartphone-->
		<section class="group5">
			<img src="<?= base_url() ?>assets/sp_0001/image/sampul/group5.svg" alt="group5">
		</section>

		<section class="group6">
			<img src="<?= base_url() ?>assets/sp_0001/image/sampul/group6.svg" alt="group6">
		</section>
		<!--/Responsive Bingkai For Apple Smartphone & Android Smartphone-->

		<!--Responsive Bingkai Smartphone small-->
		<section class="group7">
			<img src="<?= base_url() ?>assets/sp_0001/image/sampul/group7.svg" alt="group7">
		</section>

		<section class="group8">
			<img src="<?= base_url() ?>assets/sp_0001/image/sampul/group8.svg" alt="group8">
		</section>
	...
	<section class="cover" id="cover" style="background-image: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.6)),	url('../image/cover/heroCover.png');">
		...
		<audio id="music" loop>
			<source src="<?= base_url() ?>assets/sp_0001/music/music2.mpeg" type="audio/mp3">
		</audio>
	</section>

	<!---------- Wave For Desktop---------->
	<div class="wave-desk">
		<img src="<?= base_url() ?>assets/sp_0001/image/wave-mempelai-for-Desktop.svg" alt="wave for desktop">
	</div>

	<!---------- Wave For Tablets---------->
	<div class="wave-tab">
		<img src="<?= base_url() ?>assets/sp_0001/image/wave-mempelai-for-tablets.svg" alt="wave for tablets">
	</div>

	<!---------- Wave For Tablets mini---------->
	<div class="wave-tab-min">
		<img src="<?= base_url() ?>assets/sp_0001/image/wave-mempelai-for-tablets.svg" alt="wave for tablets mini">
	</div>

	<!---------- Wave For Apple & Android Smartphone---------->
	<div class="wave-AAs">
		<img src="<?= base_url() ?>assets/sp_0001/image/wave-mempelai-for-AAsmartphone.svg" alt="wave for Apple & Android smartphone">
	</div>

	<!---------- Wave For Apple Smartphone mini---------->
	<div class="wave-Ap-mini">
		<img src="<?= base_url() ?>assets/sp_0001/image/wave-mempelai-for-Ap-mini.svg" alt="wave for Apple & Android smartphone">
	</div>

	<img class="giftt" id="btnGift" src="<?= base_url() ?>assets/sp_0001/icon/in in-gift.svg" alt="gift">

	<img id="setm" class="setmus" src="<?= base_url() ?>assets/sp_0001/icon/in in-play.svg" alt="SettingMusic" onclick="setmus()">
		...
		<div class="modal-content">
			...
			<div class="card">
				...
				<div class="card-box-BCA">
					<img class="BCA-image" src="<?= base_url() ?>assets/sp_0001/image/gift_va(BCA)/gift_card_va_bca.svg" alt="Card Virtual Akun BCA">
					<div class="no_va_BCA">
						<input id="myInput_VA_BCA" type="text" value="2235577880" disabled>
						<img class="copy_VA_BCA" src="<?= base_url() ?>assets/sp_0001/icon/in in-copy.svg" alt="copy" onclick="copy_VA_BCA()">
						<span class="recipient">
							<p>*Recipient:Danteria Sah</p>
						</span>
					</div>
					<div class="barcode">
						<img class="barcode-isi" src="<?= base_url() ?>assets/sp_0001/image/gift_va(BCA)/gift_card_va_barcode(BCA).png" alt="barcode">
					</div>
				...
				<div class="card-box-BRI">
					<img class="BRI-image" src="<?= base_url() ?>assets/sp_0001/image/gift_va(BRI)/gift_card_va_bri.svg" alt="Card Virtual Akun BRI">
					<div class="no_va_BRI">
						<input id="myInput_VA_BRI" type="text" value="123456789012345" disabled>
						<img class="copy_VA_BRI" src="<?= base_url() ?>assets/sp_0001/icon/in in-copy.svg" alt="copy" onclick="copy_VA_BRI()">
						<span class="recipient">
							<p>*Recipient:Danteria Sah</p>
						</span>
					</div>
					<div class="barcode">
						<img class="barcode-isi" src="<?= base_url() ?>assets/sp_0001/image/gift_va(BRI)/gift_card_va_barcode(BRI).png" alt="barcode">
					</div>
					<div class="btn-saveQR">
						<button class="btn-saveQR_Code">Save QR Code</button>
					</div>
				...
				<div class="card-box-MANDIRI">
					<img class="MANDIRI-image" src="<?= base_url() ?>assets/sp_0001/image/gift_va(MANDIRI)/gift_card_va_mandiri.svg" alt="Card Virtual Akun MANDIRI">
					<div class="no_va_MANDIRI">
						<input id="myInput_VA_MANDIRI" type="text" value="1234567890123" disabled>
						<img class="copy_VA_MANDIRI" src="<?= base_url() ?>assets/sp_0001/icon/in in-copy.svg" alt="copy" onclick="copy_VA_MANDIRI()">
						<span class="recipient">
							<p>*Recipient:Danteria Sah</p>
						</span>
					</div>
					<div class="barcode">
						<img class="barcode-isi" src="<?= base_url() ?>assets/sp_0001/image/gift_va(MANDIRI)/gift_card_va_barcode(MANDIRI).png" alt="barcode">
					</div>
					<div class="btn-saveQR">
						<button class="btn-saveQR_Code">Save QR Code</button>
					</div>
				...
				<div class="card-box-BSI">
					<img class="BSI-image" src="<?= base_url() ?>assets/sp_0001/image/gift_va(BSI)/gift_card_va_bsi.svg" alt="Card Virtual Akun BSI">
					<div class="no_va_BSI">
						<input id="myInput_VA_BSI" type="text" value="1234567890" disabled>
						<img class="copy_VA_BSI" src="<?= base_url() ?>assets/sp_0001/icon/in in-copy.svg" alt="copy" onclick="copy_VA_BSI()">
						<span class="recipient">
							<p>*Recipient:Danteria Sah</p>
						</span>
					</div>
					<div class="barcode">
						<img class="barcode-isi" src="<?= base_url() ?>assets/sp_0001/image/gift_va(BSI)/gift_card_va_barcode(BSI).png" alt="barcode">
					</div>
					<div class="btn-saveQR">
						<button class="btn-saveQR_Code">Save QR Code</button>
					</div>
				...
				<div class="card-box-CIMBNIAGA">
					<img class="CIMBNIAGA-image" src="<?= base_url() ?>assets/sp_0001/image/gift_va(CIMBNIAGA)/gift_card_va_cimbniaga.svg" alt="Card Virtual Akun CIMBNIAGA">
					<div class="no_va_CIMBNIAGA">
						<input id="myInput_VA_CIMBNIAGA" type="text" value="12345678901234" disabled>
						<img class="copy_VA_CIMBNIAGA" src="<?= base_url() ?>assets/sp_0001/icon/in in-copy.svg" alt="copy" onclick="copy_VA_CIMBNIAGA()">
						<span class="recipient">
							<p>*Recipient:Danteria Sah</p>
						</span>
					</div>
					<div class="barcode">
						<img class="barcode-isi" src="<?= base_url() ?>assets/sp_0001/image/gift_va(CIMBNIAGA)/gift_card_va_barcode(CIMBNIAGA).png" alt="barcode">
					</div>
					<div class="btn-saveQR">
						<button class="btn-saveQR_Code">Save QR Code</button>
					</div>
				...
				<div class="card-box-DANA">
					<img class="DANA-image" src="<?= base_url() ?>assets/sp_0001/image/gift_va(DANA)/gift_card_va_dana.svg" alt="Card Virtual Akun DANA">
					<div class="no_va_DANA">
						<input id="myInput_VA_DANA" type="text" value="12345678901234567" disabled>
						<img class="copy_VA_DANA" src="<?= base_url() ?>assets/sp_0001/icon/in in-copy.svg" alt="copy" onclick="copy_VA_DANA()">
						<span class="recipient">
							<p>*Recipient:Danteria Sah</p>
						</span>
					</div>
					<div class="barcode">
						<img class="barcode-isi" src="<?= base_url() ?>assets/sp_0001/image/gift_va(DANA)/gift_card_va_barcode(DANA).png" alt="barcode">
					</div>
					<div class="btn-saveQR">
						<button class="btn-saveQR_Code">Save QR Code</button>
					</div>
	...
	<div class="content">
		<section id="mempelai">
			<div class="isi">
				<div class="bismillah" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="100">
					<img src="<?= base_url() ?>assets/sp_0001/image/bissmilah.svg" alt="Bismillah Image">
				</div>
				<div class="pembuka">
				...
				<div class="pempelai-pria" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="450">
					<p>Runa Solahudin</p>
					<a href="#"><img src="<?= base_url() ?>assets/sp_0001/image/ig.png" alt="ic-Instagram"></a>
				...
				<div class="pempelai-wanita" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="650">
					...
					<a href="#">
						<img src="<?= base_url() ?>assets/sp_0001/image/ig.png" alt="ic-Instagram"></a>
			...
			<div class="dive">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-mempelai.svg" alt="diveder">
			</div>

			<!--Diveder For Android & Apple Smartphone-->
			<div class="dive-AAs">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-mempelai-for-AAsmartphone.svg" alt="diveder">
			</div>

			<!--Diveder For Apple Smartphone mini-->
			<div class="dive-Ap-mini">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-mempelai-for-Ap-mini.svg" alt="diveder">
			</div>
		...
		<section id="waktu">
			...
			<div class="dive-waktu">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-waktu.svg" alt="diveder">
			</div>

			<!--Diveder For tablet-->
			<div class="dive-waktu-tablet">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-waktu-for-tablet.svg" alt="diveder">
			</div>

			<!--Diveder For tablet mini-->
			<div class="dive-waktu-tablet-mini">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-waktu-for-tablet-mini.svg" alt="diveder">
			</div>

			<!--Diveder For Apple & Android-->
			<div class="dive-waktu-AAs">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-waktu-AAs.svg" alt="diveder">
			</div>

			<!--Diveder For Apple mini-->
			<div class="dive-waktu-Ap-mini">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-waktu-for-Ap-mini.svg" alt="diveder">
			</div>
		</section>
		...
		<section id="galery">
			<div class="header">
				...
				<div class="jd-gal-desk">
					<img src="<?= base_url() ?>assets/sp_0001/image/gallery/jdul-galeri-for-desktop.svg" alt="Judul Galeri">
				</div>
				<!--Diveder For Apple & Android--->
				<div class="jd-gal-AAs">
					<img src="<?= base_url() ?>assets/sp_0001/image/gallery/jdul-galeri-for-AAs.svg" alt="Judul Galeri">
				</div>
				<!--Diveder For Apple mini--->
				<div class="jd-gal-Ap-mini">
					<img src="<?= base_url() ?>assets/sp_0001/image/gallery/jdul-galeri-for-Ap-mini.svg" alt="Judul Galeri">
				</div>
			</div>
			<div class="contain">
				<div class="gallery-img">
					<a href="<?= base_url() ?>assets/sp_0001/image/gallery/1.jpg" data-lightbox="models" data-title="image 1">
						<img src="<?= base_url() ?>assets/sp_0001/image/gallery/1.jpg" alt="img 1" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="250">
					</a>

					<a href="<?= base_url() ?>assets/sp_0001/image/gallery/2.png" data-lightbox="models" data-title="image 2">
						<img src="<?= base_url() ?>assets/sp_0001/image/gallery/2.png" alt="img 2" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="350">
					</a>

					<a href="<?= base_url() ?>assets/sp_0001/image/gallery/3.png" data-lightbox="models" data-title="image 3">
						<img src="<?= base_url() ?>assets/sp_0001/image/gallery/3.png" alt="img 3" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="450">
					</a>

					<a href="<?= base_url() ?>assets/sp_0001/image/gallery/4.png" data-lightbox="models" data-title="image 4">
						<img src="<?= base_url() ?>assets/sp_0001/image/gallery/4.png" alt="img 4" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="550">
					</a>

					<a href="<?= base_url() ?>assets/sp_0001/image/gallery/5.png" data-lightbox="models" data-title="image 5">
						<img src="<?= base_url() ?>assets/sp_0001/image/gallery/5.png" alt="img 5" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="650">
					</a>

					<a href="<?= base_url() ?>assets/sp_0001/image/gallery/6.png" data-lightbox="models" data-title="image 6">
						<img src="<?= base_url() ?>assets/sp_0001/image/gallery/6.png" alt="img 6" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="750">
					</a>
				</div>
			</div>
			...
			<div class="dive-galery">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-galery.svg" alt="diveder">
			</div>
			<!--Diveder galery For tablet-->
			<div class="dive-galery-tablet">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-galery-for-tablet.svg" alt="diveder">
			</div>
			<!--Diveder galery For tablet mini-->
			<div class="dive-galery-tablet-mini">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-galery-for-tablet-mini.svg" alt="diveder">
			</div>
			<!--Diveder galery For Apple & Android-->
			<div class="dive-galery-AAs">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-galery-for-AAs.svg" alt="diveder">
			</div>
			<!--Diveder For Apple mini-->
			<div class="dive-galery-Ap-mini">
				<img src="<?= base_url() ?>assets/sp_0001/image/dive-galery-for-Ap-mini.svg" alt="diveder">
			</div>
		</section>
		...
		<section id="pesan">
			...
			<div class="akhir" data-aos="fade-down-left" data-aos-duration="1000" data-aos-delay="200">
				<div class="header">
					...
					<img class="bingAtas-akhir-for-desk" src="<?= base_url() ?>assets/sp_0001/image/bingAtas-akhir-for-desktop.svg" alt="Bingkai Akhir">

					<!--Bingkai atas bagian akhir for Apple & Android Smartphone  -->
					<img class="bingAtas-akhir-for-AAs" src="<?= base_url() ?>assets/sp_0001/image/bingAtas-akhir-for-AAs.svg" alt="Bingkai Akhir">
					...
					<img class="bingBawah-akhir-for-desk" src="<?= base_url() ?>assets/sp_0001/image/bingBawah-akhir-for-desktop.svg" alt="Bingkai Akhir">

					<!--Bingkai bawah bagian akhir for Apple & Android Smartphone  -->
					<img class="bingBawah-akhir-for-AAs" src="<?= base_url() ?>assets/sp_0001/image/bingBawah-akhir-for-AAs.svg" alt="Bingkai Akhir">
				</div>
				<div class="akhir-isi">
	...
	<div class="footer">
		<div class="isi-foo">
			<img class="logo-ms" src="<?= base_url() ?>assets/sp_0001/image/logo_ms.svg" alt="Logo MetaShare">
		</div>
		<div class="kontak">
			<div class="wa">
				<img src="<?= base_url() ?>assets/sp_0001/image/wa.png" alt="Icon WhatApps">
				<p>+087899703471</p>
			</div>

			<div class="ig">
				<img src="<?= base_url() ?>assets/sp_0001/image/ig.png" alt="Icon Instagram">
	...
	<!--Lightbox CSS-->
	<script src="<?= base_url() ?>assets/sp_0001/vendor/lightbox-plus-jquery.js"></script>

	<script src="<?= base_url() ?>assets/sp_0001/js/script_.js"></script>
