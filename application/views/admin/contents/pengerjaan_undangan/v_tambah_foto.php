<div class="page-wrapper">
				...
				<div class="d-flex align-items-center">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb m-0 p-0">
							...
							<li class="breadcrumb-item" aria-current="page"><a class="text-link" href="<?= base_url('admin/invitation/settingUndangan') ?>">Setting Data Undangan</a></li>
	...
	<div class="container-fluid">
		...
		<div class="card shadow-sm px-3">
			...
			<a href="javascript:void(0)" id="btn-tambah-foto" class="btn btn-sm btn-outline-info px-3 py-1 mb-2 mt-3"><i class="fa fa-add mr-1"></i>Foto</a>
			<!-- Loop Form -->
			<div class="form-group mb-3">
