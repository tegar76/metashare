...
<head>
	...
	<title>0202|Navisa Racy|Demo</title>
	<!--Style CSS-->
...
<body>
	...
	<section class="cover" id="cover">
		...
		<div class="ndemo-desk">
			<img src="<?= base_url() ?>assets/navisa-racy/image/note-demo-for-desk.svg" alt="note demo">
		</div>

		<!--note Demo for Apple Android smartphone-->
		<div class="ndemo-AAs">
			<img src="<?= base_url() ?>assets/navisa-racy/image/note-demo-for-AAs.svg" alt="note demo">
		</div>

		<!--note Demo for Apple Apple mini-->
		<div class="ndemo-Ap-mini">
			<img src="<?= base_url() ?>assets/navisa-racy/image/note-demo-for-Apple-mini.svg" alt="note demo">
		</div>

		<div class="bCover">
			<!--<img src="<?= base_url() ?>assets/navisa-racy/image/cover/bingkaiCover.png" alt="bingkaiCover">-->
			<div class="nSingkat">
		...
		<audio id="music" loop>
			<source src="<?= base_url() ?>assets/navisa-racy/music/music2.mpeg" type="audio/mp3">
		</audio>
		...
		<div id="myModal" class="myModal">
			<div class="modal-content">
				...
				<div class="card">
					...
					<div class="card-box">
						<img class="va-image" src="<?= base_url() ?>assets/navisa-racy/image/gift_va(BRI)/gift_card_va_bri.svg" alt="Card Virtual Akun BRI">
						<div class="no-va">
						...
						<p class="recipient">*Recipient:Runa Vha Ningit</p>
						<div class="barcode">
							<img class="barcode-isi" src="<?= base_url() ?>assets/navisa-racy/image/gift_va(BRI)/gift_card_va_barcode(BRI).png" alt="barcode">
						</div>
						<div class="btn-saveQR">
							<button class="btn-saveQR_Code" onclick="fetchFile('<?= base_url('assets/images/green-shades/gift_va(BRI)/gift_card_va_barcode(BRI).png') ?>')">Save QR Code</button>
						</div>
					</div>

					<div class="card-box">
						<img class="va-image" src="<?= base_url() ?>assets/navisa-racy/image/gift_va(MANDIRI)/gift_card_va_mandiri.svg" alt="Card Virtual Akun MANDIRI">
						<div class="no-va">
						...
						<p class="recipient">*Recipient:Runa Vha Ningit</p>
						<div class="barcode">
							<img class="barcode-isi" src="<?= base_url() ?>assets/navisa-racy/image/gift_va(MANDIRI)/gift_card_va_barcode(MANDIRI).png" alt="barcode">
						</div>
						<div class="btn-saveQR">
							<button class="btn-saveQR_Code" onclick="fetchFile('<?= base_url('assets/images/green-shades/gift_va(MANDIRI)/gift_card_va_barcode(MANDIRI).png') ?>')">Save QR Code</button>
						</div>
					</div>

					<div class="card-box">
						<img class="va-image" src="<?= base_url() ?>assets/navisa-racy/image/gift_va(BSI)/gift_card_va_bsi.svg" alt="Card Virtual Akun BSI">
						<div class="no-va">
						...
						<p class="recipient">*Recipient:Runa Vha Ningit</p>
						<div class="barcode">
							<img class="barcode-isi" src="<?= base_url() ?>assets/navisa-racy/image/gift_va(BSI)/gift_card_va_barcode(BSI).png" alt="barcode">
						</div>
						<div class="btn-saveQR">
							<button class="btn-saveQR_Code" onclick="fetchFile('<?= base_url('assets/images/green-shades/gift_va(BSI)/gift_card_va_barcode(BSI).png') ?>')">Save QR Code</button>
						</div>
					</div>

					<div class="card-box">
						<img class="va-image" src="<?= base_url() ?>assets/navisa-racy/image/gift_va(CIMBNIAGA)/gift_card_va_cimbniaga.svg" alt="Card Virtual Akun CIMBNIAGA">
						<div class="no-va">
						...
						<p class="recipient">*Recipient:Runa Vha Ningit</p>
						<div class="barcode">
							<img class="barcode-isi" src="<?= base_url() ?>assets/navisa-racy/image/gift_va(CIMBNIAGA)/gift_card_va_barcode(CIMBNIAGA).png" alt="barcode">
						</div>
						<div class="btn-saveQR">
							<button class="btn-saveQR_Code" onclick="fetchFile('<?= base_url('assets/images/green-shades/gift_va(CIMBNIAGA)/gift_card_va_barcode(CIMBNIAGA).png') ?>')">Save QR Code</button>
						</div>
					</div>

					<div class="card-box">
						<img class="va-image" src="<?= base_url() ?>assets/navisa-racy/image/gift_va(DANA)/gift_card_va_dana.svg" alt="Card Virtual Akun DANA">
						<div class="no-va">
						...
						<p class="recipient">*Recipient:Runa Vha Ningit</p>
						<div class="barcode">
							<img class="barcode-isi" src="<?= base_url() ?>assets/navisa-racy/image/gift_va(DANA)/gift_card_va_barcode(DANA).png" alt="barcode">
						</div>
						<div class="btn-saveQR">
							<button class="btn-saveQR_Code" onclick="fetchFile('<?= base_url('assets/images/green-shades/gift_va(DANA)/gift_card_va_barcode(DANA).png') ?>')">Save QR Code</button>
						</div>
					</div>
				</div>
				<footer>
	...
	<section id="waktu">
		<div class="isi">
			...
			<div class="tasyakuran" data-aos="fade-down-right" data-aos-duration="1000" data-aos-delay="150">
				...
				<div class="tgl">
					<P>Kamis - Jum'at,20-21 Oktober 2023</P>
				</div>
				<div class="almt">
					<p>Jl.Pramuka Timur No.213 RT.02 RW.01 No.213 RT.02 RW.01 Purwokerto</p>
				</div>
			</div>
			<!--end tasyakuran -->
