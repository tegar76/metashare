                        ...
                        <table id="dataTable" class="table table-striped table-bordered " style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <a href="<?= base_url('Admin/MasterData/detailAdmin')?>" class="btn btn-sm btn-primary mr-1"><i data-feather="search" class="feather-14" data-toggle="tooltip" title="Detail" data-placement="top"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>1</td>
