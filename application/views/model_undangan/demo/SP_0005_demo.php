			...
			<div class="">
				...
				<div>
					...
					<p class="mt-1 sm:mt-3 text-xl 2xs:text-2xl sm:text-4xl lg:text-2xl text-tema2-light font-Oomph tracking-widest">
						22
						<span class="font-normal text-base 2xs:text-xl sm:text-2xl lg:text-base">Januari</span>
						<span>2022</span>
					</p>
				</div>
				...
				<div class="flex justify-center">
					...
					<div class="hidden lg:flex flex-col  w-[50vw] justify-center items-center bg-tema2-semi-light">
						<div class="shadow-lg shadow-tema2-dark rounded-[40px]" data-aos="zoom-in-left" data-aos-easing="ease-out-cubic" data-aos-duration="500">
							<img src="<?= base_url() ?>assets/images/foto_cover_full.jpg" alt="" class="w-96 my-auto border-2 border-tema2-light rounded-[40px]">
						</div>
			...
			<div class="flex justify-center items-center text-center">
				...
				<div class="text-base-xs 2xs:text-base-sm 1xs:text-base-md md:text-[26px] lg:text-base lg:leading-6 text-tema2-light">
					...
					<div class="flex" data-aos="zoom-in" data-aos-duration="1000">
						<img src="<?= base_url('assets/images/mempelai_pria.PNG') ?>" alt="" class="mx-auto mt-3 md:mt-8 w-[80px] 1xs:w-[120px] lg:w-[130px] xl:w-[140px] h-[80px] 1xs:h-[120px] lg:h-[130px] xl:h-[140px] rounded-full">
					</div>
					...
					<div class="flex" data-aos="zoom-in" data-aos-duration="1000">
						<img src="<?= base_url('assets/images/mempelai_wanite.PNG') ?>" alt="" class="mx-auto mt-3 md:mt-8 w-[80px] 1xs:w-[120px] lg:w-[130px] xl:w-[140px] h-[80px] 1xs:h-[120px] lg:h-[130px] xl:h-[140px] rounded-full">
					</div>
					<div class="text-center font-semibold mt-5 lg:mt-10 font-LowBudget tracking-widest text-1xl 2xs:text-2xl sm:text-3xl md:text-[50px] lg:text-3xl text-tema2-semi-light saturate-150 contrast-150" data-aos="zoom-in" data-aos-duration="1000">
			...
			<div class="border border-tema2-semi-light/30 pb-3 md:pb-5 lg:pt-10 pt-5 md:pt-8 rounded-2xl lg:rounded-3xl relative mx-6 1xs:mx-16 md:mx-24  px-4 md:px-8 lg:px-16" data-aos="zoom-out-left" data-aos-duration="1000" data-aos-delay="1000">
				...
				<div class="columns-2 gap-x-2 lg:gap-x-4 md:columns-5xs lg:columns-4xs xl:columns-3xs" id="objekFoto">
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300  aspect-w-5 aspect-h-3  mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= base_url() ?>assets/images/foto_1.png" alt="photo" data-magnify="gallery" data-src="<?= base_url() ?>assets/images/foto_1.png">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= base_url() ?>assets/images/foto_2.png" alt="photo" data-magnify="gallery" data-src="<?= base_url() ?>assets/images/foto_2.png">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= base_url() ?>assets/images/foto_3.png" alt="photo" data-magnify="gallery" data-src="<?= base_url() ?>assets/images/foto_3.png">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= base_url() ?>assets/images/foto_4.png" alt="photo" data-magnify="gallery" data-src="<?= base_url() ?>assets/images/foto_4.png">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= base_url() ?>assets/images/foto_5.png" alt="photo" data-magnify="gallery" data-src="<?= base_url() ?>assets/images/foto_5.png">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= base_url() ?>assets/images/foto_6.png" alt="photo" data-magnify="gallery" data-src="<?= base_url() ?>assets/images/foto_6.png">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= base_url() ?>assets/images/foto_7.png" alt="photo" data-magnify="gallery" data-src="<?= base_url() ?>assets/images/foto_7.png">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= base_url() ?>assets/images/foto_8.png" alt="photo" data-magnify="gallery" data-src="<?= base_url() ?>assets/images/foto_8.png">
					</div>
				</div>
