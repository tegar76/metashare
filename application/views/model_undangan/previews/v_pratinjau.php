						...
						<div class="border-2 border-dashed border-sky-800/40 shadow-md shadow-slate-400/40 pb-3 mt-12 px-5 lg:px-8 lg:pt-10 pt-5 rounded-xl relative bg-white bg-opacity-20 xl:ml-28">
							...
							<div class="columns-2 gap-x-2 xl:gap-x-3 md:columns-5xs lg:columns-4xs xl:columns-3xs" id="objekFoto">
								<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300  aspect-w-5 aspect-h-3  mb-2 xl:mb-3">
									<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photo[0]['img'] ?>" photo-id="<?= $photo[0]['id'] ?>" alt="photo">
								</div>
								<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
									<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photo[1]['img'] ?>" photo-id="<?= $photo[1]['id'] ?>" alt="photo">
								</div>
								<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
									<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photo[2]['img'] ?>" photo-id="<?= $photo[2]['id'] ?>" alt="photo">
								</div>
								<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
									<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photo[3]['img'] ?>" photo-id="<?= $photo[3]['id'] ?>" alt="photo">
								</div>
								<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
									<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photo[4]['img'] ?>" photo-id="<?= $photo[4]['id'] ?>" alt="photo">
								</div>
								<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
									<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photo[5]['img'] ?>" photo-id="<?= $photo[5]['id'] ?>" alt="photo">
								</div>
								<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
									<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photo[6]['img'] ?>" photo-id="<?= $photo[6]['id'] ?>" alt="photo">
								</div>
								<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
									<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photo[7]['img'] ?>" photo-id="<?= $photo[7]['id'] ?>" alt="photo">
								</div>
							</div>
