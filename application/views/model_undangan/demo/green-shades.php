...
<body>
	...
	<section class="cover" id="cover">
		...
		<div class="bCover">
			<!--<img src="assets/images/green-shades/cover/bingkaiCover.png" alt="bingkaiCover">-->
			<div class="nSingkat">
		...
		<!---------- Wave For Desktop---------->
		<div class="wave-desk">
			<img src="<?= base_url('assets/images/green-shades/wave-mempelai-for-Desktop.svg') ?>" alt="wave for desktop">
		</div>

		<!---------- Wave For Tablets---------->
		<div class="wave-tab">
			<img src="<?= base_url('assets/images/green-shades/wave-mempelai-for-tablets.svg') ?>" alt="wave for tablets">
		</div>

		<!---------- Wave For Apple & Android Smartphone---------->
		<div class="wave-AAs">
			<img src="<?= base_url('assets/images/green-shades/wave-mempelai-for-AAsmartphone.svg') ?>" alt="wave for Apple & Android smartphone">
		</div>

		<!---------- Wave For Apple Smartphone mini---------->
		<div class="wave-Ap-mini">
			<img src="<?= base_url('assets/images/green-shades/wave-mempelai-for-Ap-mini.svg') ?>" alt="wave for Apple & Android smartphone">
		</div>
