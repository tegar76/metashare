...
<head>
	...
	<!-- Css -->
	<link href="<?= base_url('assets/style/tema-2-special-1.css') ?>" rel="stylesheet" />
...
<body class="font-Montserrat bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-tema2-dark via-tema2-primary to-tema2-dark bg-opacity-60 text-tema2-light">
			...
			<div class="">
				...
				<div class="border relative mt-8 rounded-3xl border-tema2-light">
					<div class="flex -mb-8 flex-wrap justify-center mt-5 sm:mt-12 lg:mt-8">
						<div class="w-36 2xs:w-40 sm:w-60 lg:w-36">
							<img src="<?= base_url('assets/images/cover_250x250.png') ?>" class="shadow-xl max-w-full h-auto align-middle border-b-4 border-2 border-tema2-light rounded-3xl" />
						</div>
					</div>
				...
				<div>
					...
					<p class="mt-1 sm:mt-3 text-xl 2xs:text-2xl sm:text-4xl lg:text-2xl text-tema2-light font-Oomph tracking-widest">
						<?= $akadDate['tanggal'] ?>
						<span class="font-normal text-base 2xs:text-xl sm:text-2xl lg:text-base"><?= $akadDate['bulan'] ?></span>
				...
				<div class="">
					...
					<p class="text-tema2-light leading-4 lg:leading-3 my-3 text-base-2xs 2xs:text-base-1xs sm:text-base-md lg:text-base-1xs">
						*Mohon Maaf Bila Ada Kesalahan Dalam <br> Penulisan Nama dan Gelar
					</p>
				</div>
			...
			<div class="w-screen h-screen bg-cover bg-cover-mobile lg:bg-none lg:bg-tema2-semi-dark text-center">
				<div class="flex justify-center">
						...
						<div class="flex">
							<div class="bg-tema2-dark/30 border border-tema2-light lg:border-0 lg:bg-transparent lg:shadow-none w-full h-full my-auto rounded-lg text-center mx-auto font-LowBudget text-3xl 2xs:text-5xl sm:text-5xl md:text-[68px] lg:text-5xl text-tema2-light lg:text-tema2-semi-light tracking-widest shadow-tema2-semi-light shadow-sm p-3 lg:mt-32" data-aos="zoom-in-down" data-aos-easing="ease-out-cubic" data-aos-duration="500">
								...
								<div class="flex justify-center items-center opacity-80">
									<img src="<?= base_url('assets/ilustrations/tema2/ils_cover1.svg') ?>" alt="">
								</div>
							</div>
						</div>
						<div class="flex">
							...
							<div class="border border-tema2-light w-fit mx-auto px-8 py-2 md:pb-8 lg:py-5 rounded-xl lg:rounded-3xl mt-6 md:mt-12 lg:mt-14 text-tema2-light bg-tema2-semi-dark/60 font-light font-Oomph" data-aos="zoom-in-top" data-aos-easing="ease-out-cubic" data-aos-duration="500">
								...
								<div class="flex gap-x-4 mt-2 lg:saturate-200 justify-center items-center">
									<div>
										<h1 class="text-lg 2xs:text-2xl sm:text-3xl md:text-4xl lg:text-2xl" id="hours">0</h1>
					...
					<div class="hidden lg:flex flex-col  w-[50vw] justify-center items-center bg-tema2-semi-light">
						<div class="shadow-lg shadow-tema2-dark rounded-[40px]" data-aos="zoom-in-left" data-aos-easing="ease-out-cubic" data-aos-duration="500">
							<img src="<?= base_url('storage/invitations/uploads/' . $invitation->cover_image_2) ?>" alt="" class="w-96 my-auto border-2 border-tema2-light rounded-[40px]">
						</div>
		...
		<section class="pb-8 pt-8 lg:pt-0 px-6 1xs:px-16 md:px-24 lg:px-72 relative" id="sambutan">
			<div class="flex justify-center items-center text-center">
				...
				<div class="text-base-xs 2xs:text-base-sm 1xs:text-base-md md:text-[26px] lg:text-base lg:leading-6 text-tema2-light">
					<div class="flex" data-aos="zoom-in" data-aos-duration="1000"><img src="<?= base_url('assets/icons/tema2/sambutan_bismillah_white.svg') ?>" class="mx-auto mb-4 lg:mt-5 md:mb-7 w-[160px] 2xs:w-[180px] 1xs:w-[210px] md:w-[260px] lg:w-[250px]" alt="">
					</div>
					<h1 class=" mb-5 md:mb-7 opacity-95 font-MontserratBold text-base-md 1xs:text-md md:text-3xl lg:text-xl text-tema2-light" data-aos="zoom-in" data-aos-duration="1000">
					...
					<div class="flex" data-aos="zoom-in" data-aos-duration="1000">
						<img src="<?= base_url('storage/invitations/uploads/' . $invitation->groom_img) ?>" alt="" class="mx-auto mt-3 md:mt-8 w-[80px] 1xs:w-[120px] lg:w-[130px] xl:w-[140px] h-[80px] 1xs:h-[120px] lg:h-[130px] xl:h-[140px] rounded-full">
					</div>
					...
					<div class="flex " data-aos="zoom-in" data-aos-duration="1000">
						<a target="_blank" href="https://www.instagram.com/<?= $invitation->groom_ig ?>" class="mx-auto my-3 md:my-5 lg:my-3 opacity-90 hover:opacity-100">
					...
					<div class="flex" data-aos="zoom-in" data-aos-duration="1000">
						<img src="<?= base_url('storage/invitations/uploads/' . $invitation->bride_img) ?>" alt="" class="mx-auto mt-3 md:mt-8 w-[80px] 1xs:w-[120px] lg:w-[130px] xl:w-[140px] h-[80px] 1xs:h-[120px] lg:h-[130px] xl:h-[140px] rounded-full">
					</div>
					<div class="text-center font-semibold mt-5 lg:mt-10 font-LowBudget tracking-widest text-1xl 2xs:text-2xl sm:text-3xl md:text-[50px] lg:text-3xl text-tema2-semi-light saturate-150 contrast-150" data-aos="zoom-in" data-aos-duration="1000">
						<p class=""><?= $invitation->bride_name ?></p>
					</div>
					<div class="flex " data-aos="zoom-in" data-aos-duration="1000">
						<a target="_blank" href="https://www.instagram.com/<?= $invitation->bride_ig ?>" class="mx-auto my-3 md lg:my-3:my-8 opacity-90 hover:opacity-100">
							<img class="w-5 md:w-8 lg:w-6" src="<?= base_url() ?>assets/icons/tema2/sambutan_insta.svg" alt="">
						</a>
					</div>
					<p class="font-MontserratBold" data-aos="zoom-in" data-aos-duration="1000">
					...
					<div class="lg:flex lg:gap-x-6">
						...
						<div class="lg:w-[27vw] mt-5 md:mt-8 items-center border border-tema2-semi-light/30 shadow-sm shadow-tema2-semi-light/20 rounded-2xl lg:rounded-3xl bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-tema2-semi-dark via-tema2-semi-dark/60 to-tema2-semi-dark relative" data-aos="fade-right" data-aos-delay="500" data-aos-duration="1000">
							...
							<div class="pt-3 pb-5 px-3 md:pt-8 md:pb-8 lg:px-3  font-semibold text-base-xs 2xs:text-base-sm md:text-[26px]  lg:text-base-md text-tema2-light/90 tracking-wider">
								...
								<p class="mb-1 text-tema2-light"><?= $acara['tasyakur']['tanggal']; ?> </p>
								<p class="mb-2 text-tema2-light"><?= $acara['tasyakur']['waktu']; ?> - Selesai </p>
								<p class=" text-tema2-light mb-3"><?= $acara['tasyakur']['alamat']; ?></p>
								<p class="text-tema2-semi-light text-base-1xs 2xs:text-base-xs md:text-xl lg:text-sm">
						...
						<div class="lg:w-[27vw] mt-5 md:mt-8 items-center border border-tema2-semi-light/30 shadow-sm shadow-tema2-semi-light/20 rounded-2xl lg:rounded-3xl  bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-tema2-semi-dark via-tema2-semi-dark/60 to-tema2-semi-dark relative" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
							...
							<div class="pt-3 pb-5 px-3 md:pt-8 md:pb-8 lg:px-3  font-semibold text-base-xs 2xs:text-base-sm md:text-[26px]  lg:text-base-md text-tema2-light/90 tracking-wider">
								<h1 class=" mb-3 md:mb-8 font-MontserratBold text-base 2xs:text-md 1xs:text-tiny md:text-[30px] lg:text-xl">
									Akad</h1>
								<p class="mb-1 text-tema2-light"><?= $acara['akad']['tanggal'] ?></p>
								<p class="mb-2 text-tema2-light"><?= $acara['akad']['waktu'] ?></p>
								<p class=" text-tema2-light mb-3"><?= $acara['akad']['alamat'] ?></p>
								<p class="text-tema2-semi-light text-base-1xs 2xs:text-base-xs md:text-xl lg:text-sm">(Kediaman Mempelai Pria)</p>
						...
						<div class="lg:w-[27vw] mt-5 md:mt-8 items-center border border-tema2-semi-light/30 shadow-sm shadow-tema2-semi-light/20 rounded-2xl lg:rounded-3xl  bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-tema2-semi-dark via-tema2-semi-dark/60 to-tema2-semi-dark relative" data-aos="fade-left" data-aos-delay="500" data-aos-duration="1000">
							...
							<div class="pt-3 pb-5 px-3 md:pt-8 md:pb-8 lg:px-3 font-semibold text-base-xs 2xs:text-base-sm md:text-[26px]  lg:text-base-md text-tema2-light/90 tracking-wider">
								...
								<p class="mb-1 text-tema2-light"><?= $acara['resepsi']['tanggal'] ?></p>
								<p class="mb-2 text-tema2-light"><?= $acara['resepsi']['waktu'] ?></p>
								<p class=" text-tema2-light mb-3"><?= $acara['resepsi']['alamat'] ?></p>
			...
			<div class="border border-tema2-semi-light/30 pb-3 md:pb-5 lg:pt-10 pt-5 md:pt-8 rounded-2xl lg:rounded-3xl relative mx-6 1xs:mx-16 md:mx-24  px-4 md:px-8 lg:px-16" data-aos="zoom-out-left" data-aos-duration="1000" data-aos-delay="1000">
				...
				<div class="columns-2 gap-x-2 lg:gap-x-4 md:columns-5xs lg:columns-4xs xl:columns-3xs" id="objekFoto">
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300  aspect-w-5 aspect-h-3  mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= $photos[0]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[0]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= $photos[1]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[1]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= $photos[2]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[2]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= $photos[3]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[3]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= $photos[4]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[4]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= $photos[5]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[5]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= $photos[6]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[6]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer border-tema2-semi-light/30 hover:border-2 hover:border-tema2-primary" src="<?= $photos[7]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[7]['img']; ?>">
					</div>
				</div>

				<div class="mb-2 mt-4">
					<div class="flex justify-center content-center ">
						<video class="gdriveVideo md:h-72 rounded-2xl view-photo cursor-pointer" preload="auto" controls poster="<?= $photos[0]['img']; ?>">
		...
		<div id="perjalananCinta">
			<div class="">
				...
				<div class="absolute right-5 w-16 2xs:w-20 1xs:w-28 sm:w-32 md:w-36 lg:w-40 xl:hidden">
					<img src="<?= base_url() ?>assets/ilustrations/tema2/percin_lg.svg" alt="ils percin" data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="500">
				</div>
			</div>
			...
			<div class="pt-8 mt-10 pb-8 lg:pt-10 relative">
				<div class="xl:flex mx-6 1xs:mx-16 md:mx-24 xl:items-center">
								...
								<li class="mb-10 lg:mb-14 ml-8">
									<div class="relative border border-tema2-light/30 shadow-sm bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-tema2-semi-dark via-tema2-semi-dark/60 to-tema2-semi-dark shadow-tema2-semi-dark text-tema2-semi-light/60 rounded-2xl lg:rounded-3xl">
										<div class="absolute border bg-tema2-primary saturate-150 border-tema2-semi-light/40 shadow-sm shadow-tema2-semi-dark text-tema2-semi-light/60 text-base-xs 2xs:text-base-sm 1xs:text-base-md md:text-[26px] lg:text-base lg:leading-6 text-tema2-semi-light tracking-widest font-semibold px-3 py-1 rounded-xl left-1/2 transform -translate-x-1/2 -translate-y-1/2 -top-1">
											<p class="contrast-150">Kisah <?= $storyIncrement++ ?></p>
										</div>
										<div class="mt-3">
											<div class="absolute w-7 h-7 text-tema2-semi-light b bg-tema2-primary saturate-150 border-tema2-semi-light/40 shadow-sm shadow-tema2-semi-dark rounded-full -left-12 border">
												<p class="font-MontserratBold font-bold ml-2"><?= $increment++ ?></p>
											</div>
											<div class="story mx-3">
												...
												?>
												<time class="my-4 text-base-xs 2xs:text-base-sm 1xs:text-base-md md:text-[26px] lg:text-base lg:leading-6 font-normal leading-none text-tema2-semi-light"><?= $newDate; ?></time>
					...
					<div class="hidden xl:block" data-aos="zoom-out-down" data-aos-duration="1000">
						<img class="opacity-70" src="<?= base_url() ?>assets/ilustrations/tema2/percin_lg.svg" alt="">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="modal-body relative p-4">
					...
					<?php foreach ($gifts as $gift) : ?>
						<div class="rounded-lg p-4 my-5 tracking-widest shadow-md shadow-tema2-light/10 border border-tema2-light/30">
							<div class="px-2 py-3">
								<div class="">
									<img class="w-20" src="<?= base_url('storage/') . $gift->icon ?>" alt="bca">
									s
								</div>
								<div class="flex mt-4">
									<div>
										<p class="font-semibold mr-3 text-base-xs 2xs:text-base-md 1xs:text-sm md:text-[20px] lg:text-base-sm lg:leading-6 text-tema2-light" id="<?= $gift->id ?>"><?= $gift->account ?></p>
									</div>
								...
								<div>
									<p class="text-base-1xs 2xs:text-base-xs 1xs:text-base-sm md:text-[16px] lg:text-[15px] lg:leading-6 font-normal text-tema2-light">
										a.n. <span class="text-tema2-light"><?= $gift->recipient ?></span>
									</p>
								</div>
	...
	<script>
		...
		iconMusic.onclick = function() {
			if (song.paused) {
				song.play();
				iconMusic.src = "<?= base_url() ?>assets/icons/tema2/floating_music_play_dark.svg"
				iconMusic.classList.add('animate-spin-slow')
			} else {
				song.pause();
				iconMusic.src = "<?= base_url() ?>assets/icons/tema2/floating_music_paused_dark.svg"
