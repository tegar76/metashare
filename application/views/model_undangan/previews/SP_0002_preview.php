				...
				<div>
					<div class="flex flex-wrap justify-center mt-8 sm:mt-12 lg:mt-8">
						<div class="w-32 2xs:w-40 sm:w-60 lg:w-36 px-4">
							<!-- Source cover image -->
							<img src="<?= base_url('storage/invitations/uploads/' . $invitation->cover_image_1) ?>" class="shadow-xl rounded-full max-w-full h-auto align-middle border-b-2" />
						</div>
					</div>
			...
			<div class="flex justify-center items-center text-center">
				...
				<div class="text-base-xs 2xs:text-base-sm 1xs:text-base-md md:text-[26px] lg:text-base lg:leading-6 text-slate-900">
					...
					<div class="flex" data-aos="zoom-in" data-aos-duration="1000">
						<!-- Groom image -->
						<img src="<?= base_url('storage/invitations/uploads/' . $invitation->groom_img) ?>" alt="groom_image" class="w-[80px] 1xs:w-[120px] lg:w-[130px] xl:w-[140px] mx-auto mt-3 md:mt-8 rounded-full">
					</div>
					...
					<div class="flex" data-aos="zoom-in" data-aos-duration="1000">
						<!-- Bride image -->
						<img src="<?= base_url('storage/invitations/uploads/' . $invitation->bride_img) ?>" alt="" class="mx-auto mt-3 md:mt-8 w-[80px] 1xs:w-[120px] lg:w-[130px] xl:w-[140px]">
					</div>
					<div class="text-center font-semibold mt-5 lg:mt-10 font-RadicalsDemo tracking-widest text-2xl 2xs:text-3xl sm:text-4xl md:text-[55px] lg:text-4xl text-tema1-pink" data-aos="zoom-in" data-aos-duration="1000">
						<!-- bride name -->
			...
			<div class="border border-tema1-teal/40 shadow-sm shadow-tema1-teal/80 pb-3 md:pb-5 mt-10 lg:pt-10 pt-5 md:pt-8 rounded-2xl lg:rounded-3xl relative bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-100/80 via-[#ebeeee] to-[#f4f5f5] mx-6 1xs:mx-16 md:mx-24  px-4 md:px-8 lg:px-16" data-aos="zoom-out-left" data-aos-duration="1000" data-aos-delay="1000">
				...
				<div class="columns-2 gap-x-2 lg:gap-x-4 md:columns-5xs lg:columns-4xs xl:columns-3xs" id="objekFoto">
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300  aspect-w-5 aspect-h-3  mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[0]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[0]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[1]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[1]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[2]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[2]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[3]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[3]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[4]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[4]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[5]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[5]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[6]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[6]['img']; ?>">
					</div>
					<div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
						<img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[7]['img']; ?>" alt="photo" data-magnify="gallery" data-src="<?= $photos[7]['img']; ?>">
					</div>
				</div>
				...
				<div class="mb-2">
					...
					<div class="flex justify-center content-center ">
						<video class="gdriveVideo md:h-72 rounded-2xl view-photo cursor-pointer" preload="auto" controls poster="">
									...
									<div class="relative border border-tema1-pink/40 shadow-sm shadow-tema1-pink/60 rounded-2xl lg:rounded-3xl bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-100/80 via-[#f5f3ec] to-[#f4f5f5]">
										...
										<div class="mt-3">
											...
											<div class="story mx-3">
												...
												?>
												<time class="my-4 text-base-xs 2xs:text-base-sm 1xs:text-base-md md:text-[26px] lg:text-base lg:leading-6 font-normal leading-none text-tema1-teal"><?= $newDate; ?></time>
												<p class="mb-4 text-base-xs 2xs:text-base-sm 1xs:text-base-md md:text-[26px] lg:text-base lg:leading-6 font-normal text-slate-800 text-justify">
													<?= $story->story ?>
												</p>
											</div>
										</div>
