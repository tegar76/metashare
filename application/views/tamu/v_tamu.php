...
<body class="font-Montserrat bg-primary bg-cover">
    <header>
        <nav>
            <!-- Nav -->
            <div id="bottom-navigation" class="hidden fixed inset-x-0 bottom-3 z-0 lg:top-3/10 lg:w-14 lg:h-fit ">
                <div id="tabs" class="tabs bg-white border border-sky-800/30 shadow-lg flex rounded-3xl w-[60%] mx-auto lg:w-14 lg:h-fit lg:py-3 lg:shadow-md lg:block lg:mx-0 lg:ml-5">
    ...
    <main>
        ...
        <div class="content mb-20 lg:mb-0" id="home" data-page="home">
            <section id="home" class="">
                <div class="content-cover relative w-screen h-screen bg-cover bg-top bg-no-repeat overflow-hidden lg:w-[100%] bg-cover-full lg:bg-cover-crop lg:bg-[position:top] shadow-md shadow-['#b5b5b5']">
                    <div class="">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center top-[500px] text-white font-semibold" x-data="countdown()" x-init="start()">
                            <div class="text-center block columns-4">
                                ...
                                <div class=" text-white font-semibold font-mono text-sm leading-none">Detik</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-main text-slate-900 font-medium text-center">
                <div class="bg-sambutan-sm xl:bg-sambutan-xl bg-cover pb-8 pt-5">
                        ...
                        <section id="sambutan" class="mb-5 xl:w-[70%]">
                            <div class="mx-5 lg:ml-28 lg:mx-0">
                                ...
                                <div id="objekSambutan">
                                    ...
                                    <div class="text-center font-semibold opacity-80 mt-5 font-BacktoBlack tracking-widest text-2xl lg:text-3xl text-[#CCA829] ">
                            ...
                            <div class="bg-resepsi bg-no-repeat bg-cover bg-center xl:bg-transparent xl:bg-none xl:shadow-none">
                                <div class="mx-8 py-8" id="objekResepsi">
                                    ...
                                    <div class="mt-5 items-center border border-sky-800 border-opacity-30 rounded-xl bg-yellow-50 bg-opacity-20">
                                        <img class=" absolute  w-10 lg:w-14 opacity-30" src="<?= base_url('assets/icons/sambutan_flower3.svg') ?>" />
                                        <div class=" pt-3 pb-5 px-12 lg:px-3">
                                            <h1 class="font-MontserratBold font-semibold text-tiny mb-3 opacity-60 lg:text-xl">Resepsi</h1>
                                            <p class="mb-1 text-center">Sabtu, 22 Oktober 2022</p>
                                            <p class="mb-1 text-center">Minggu, 23 Oktober 2022</p>
                                            <p class="mb-1 text-center">10.00 WIB - Selesai</p>
                                            <h1 class="font-MontserratBold font-semibold opacity-60 text-tiny mt-5 mb-3  lg:text-xl">Akad Nikah</h1>
                                            <p class="mb-1 text-center">Minggu, 23 Oktober 2022</p>
                                            <p class="mb-1 text-center">10.00 WIB - Selesai</p>
                ...
                <section id="foto" class="">
                    <div class="mb-5 mx-5 xl:mr-10 pt-14">
                        ...
                        <div class="border-2 border-dashed border-sky-800/30 shadow-md shadow-slate-400/40 pt-8 pb-3 mt-12 px-5 lg:px-8 lg:pt-10 rounded-xl relative bg-yellow-50/20 xl:ml-28">
                            ...
                            <?
                            $photos = [
                                base_url('assets/img/foto_1.jpg'),
                                base_url('assets/img/foto_2.jpg'),
                                base_url('assets/img/foto_3.jpg'),
                                base_url('assets/img/foto_5.jpg'),
                                base_url('assets/img/foto_4.jpg'),
                                base_url('assets/img/foto_6.jpg'),
                                base_url('assets/img/foto_7.jpg'),
                                base_url('assets/img/foto_8.jpg'),
                            ];
                            ?>
                            ...
                            <div class="columns-2 gap-x-2 xl:gap-x-3 md:columns-5xs lg:columns-4xs xl:columns-3xs" id="objekFoto">
                                <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300  aspect-w-5 aspect-h-3  mb-2 xl:mb-3">
                                    <img class="w-full rounded-2xl border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[0] ?>" alt="">
                                </div>
                                <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
                                    <img class="w-full rounded-2xl border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[1] ?>" alt="">
                                </div>
                                <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
                                    <img class="w-full rounded-2xl border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[2] ?>" alt="">
                                </div>
                                <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
                                    <img class="w-full  rounded-2xl border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[3] ?>" alt="">
                                </div>
                                <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
                                    <img class="w-full  rounded-2xl border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[4] ?>" alt="">
                                </div>
                                <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
                                    <img class="w-full rounded-2xl border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[5] ?>" alt="">
                                </div>
                                <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
                                    <img class="w-full  rounded-2xl border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[6] ?>" alt="">
                                </div>
                                <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
                                    <img class="w-full rounded-2xl border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= $photos[7] ?>" alt="">
                                </div>
                            </div>
                ...
                <section id="pesanBahagia" class="mb-5 xl:ml-28">
                    <div>
                        ...
                        <div class="xl:flex xl:mx-5 xl:border xl:border-sky-800 xl:border-opacity-30 xl:rounded-xl xl:py-5 xl:mr-10">
                            <div class="xl:w-[70%] text-left mt-7 lg:mt-1">
                                <div class="bg-pesan-bahagia-sm bg-no-repeat bg-cover bg-center xl:bg-transparent xl:bg-none xl:shadow-none">
            ...
            <footer class="p-4 lg:mt-12 bg-slate-600/5 rounded-lg shadow md:px-2 md:py-4">
                <div class="mb-14 lg:mb-0 flex justify-center items-center">
                    <div class="flex ml-3">
                        ...
                        <div class="flex justify-center items-center w-1/2 ml-5">
                            <a target="_blank" href="https://wa.me//087899703471" class="flex">
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="modalGiftCard" tabindex="-1" aria-labelledby="modalGiftCard" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable relative w-auto pointer-events-none">
            <div class="modal-content border-slate-400 border border-dashed border-opacity-70 shadow-lg relative flex flex-col w-full pointer-events-auto bg-[#f9fafa] bg-opacity-90  bg-clip-padding rounded-md outline-none text-current  backdrop-blur-md">
                <div class="modal-header text-center p-4 border-b border-slate-400 border-opacity-50 border-dashed rounded-t-md">
                    <h5 class="font-BacktoBlack tracking-widest text-lg lg:text-xl leading-normal mb-2 opacity-60" id="modalGiftCardLabel">
                        Berikan Hadiah
                    </h5>
                    <p class="text-center text-xs lg:text-sm text-slate-600">Tanpa mengurangi rasa hormat, untuk melengkapi kebahagian kami, anda dapat memberikan tanda kasih dengan transfer ke rekening berikut :</p>
                </div>
    ...
    <div class="modal-foto opacity-0 pointer-events-none z-30 fixed h-screen w-screen flex items-center justify-center">
        ...
        <div class="modal-foto-container fixed w-full h-full  overflow-y-auto ">
            ...
            <div class="modal-foto-content container mx-auto text-left">
                ...
                <div class="flex ="> <img class="mx-auto max-w-screen max-h-screen border scale-90 xs:scale-[85%]" src="<?= $photos[6] ?>">
                </div>
