													...
													<div id="carouselCoverSpecial<?= $item->model_id ?>" class="carousel slide relative" data-bs-ride="carousel">
														...
														<div class=" carousel-inner relative w-full overflow-hidden">
															<div class="carousel-item active float-left w-full rounded-xl shadow-xl">
																<img src="<?= base_url('storage/model_undangan_sampul/' . $item->cover_1) ?>" class=" block w-[270px] h-[378px] object-cover rounded-xl shadow-xl" alt="Sampul" />
															</div>
															<div class="carousel-item float-left w-full rounded-xl shadow-xl">
																<img src="<?= base_url('storage/model_undangan_sampul/' . $item->cover_2) ?>" class=" block w-[270px] h-[378px] object-cover  rounded-xl shadow-xl" alt="Sampul" />
															</div>
														</div>
											...
											<div class="cover-image w-[80vw] xs:w-full border border-slate-400/30 rounded-2xl flex justify-center">
												<div class="mx-3">
													<div id="carouselCoverStandard<?= $row->model_id ?>" class="carousel slide relative" data-bs-ride="carousel">
														...
														<div class=" carousel-inner relative w-full overflow-hidden">
															<div class="carousel-item active float-left w-full rounded-xl shadow-xl">
																<img src="<?= base_url('storage/model_undangan_sampul/' . $row->cover_1) ?>" class=" block w-[270px] h-[378px]  object-cover  rounded-xl shadow-xl" alt="Sampul" />
															</div>
															<div class="carousel-item float-left w-full">
																<img src="<?= base_url('storage/model_undangan_sampul/' . $row->cover_2) ?>" class=" block w-[270px] h-[378px]  object-cover  rounded-xl shadow-xl " alt="Sampul" />
															</div>
														</div>
													...
													<div class="flex mb-4 justify-center">
														<a target="_blank" href="<?= base_url('preview?model=' . $row->view_model) ?>" class="text-base-xs xl:text-sm border text-primary-blue-cyan/70 border-primary-blue-cyan/70 px-3 py-1 rounded-lg hover:bg-primary-blue-cyan hover:text-white hover:border-white mr-3"> <i class="fa fa-eye"></i> Demo</a>
														<a href="" class="text-base-xs xl:text-sm border text-white border-success bg-success px-3 py-1 rounded-lg hover:bg-success-hover hover:border-success-hover hover:text-white"> <i class="fa-brands fa-whatsapp fa-lg"></i> Order</a>
													</div>
												</div>
											</div>
								...
								<div class="relative">
									<div class="flex justify-center items-center">
													...
													<div id="carouselCoverBasic<?= $value->model_id ?>" class="carousel slide relative" data-bs-ride="carousel">
														...
														<div class=" carousel-inner relative w-full overflow-hidden">
															<div class="carousel-item active float-left rounded-xl shadow-xl">
																<img src="<?= base_url('storage/model_undangan_sampul/' . $value->cover_1) ?>" class=" block w-[270px] h-[378px]  object-cover  rounded-xl shadow-xl" alt="Sampul" />
															</div>
															<div class="carousel-item float-left w-full">
																<img src="<?= base_url('storage/model_undangan_sampul/' . $value->cover_2) ?>" class=" block w-[270px] h-[378px]  object-cover  rounded-xl shadow-xl " alt="Sampul" />
															</div>
														</div>
                                        ...
                                        <div><button>kfdldnf</button></div>
													...
													<div class="flex mb-4 justify-center">
														<a target="_blank" href="<?= base_url('preview?model=' . $value->view_model) ?>" class="text-base-xs xl:text-sm border text-primary-blue-cyan/70 border-primary-blue-cyan/70 px-3 py-1 rounded-lg hover:bg-primary-blue-cyan hover:text-white hover:border-white mr-3"> <i class="fa fa-eye"></i> Demo</a>
														<a href="" class="text-base-xs xl:text-sm border text-white border-success bg-success px-3 py-1 rounded-lg hover:bg-success-hover hover:border-success-hover hover:text-white"> <i class="fa-brands fa-whatsapp fa-lg"></i> Order</a>
													</div>
												</div>
											</div>
