...
<head>
    ...
    <link href="<?= base_url('assets/plugin/magnify-master/docs/css/magnify-white-theme.css')?>" rel="stylesheet" />

    <link href="<?= base_url('assets/plugin/magnify-master/docs/css/docs.css')?>" rel="stylesheet">
    <script src="<?= base_url('assets/plugin/magnify-master/docs/js/jquery.magnify.js')?>"></script>

    <!-- AOS -->
    <link href="<?= base_url('src/style/tailwindCss/node_modules/aos/dist/aos.css')?>" rel="stylesheet">
    <script src="<?= base_url('src/style/tailwindCss/node_modules/aos/dist/aos.js')?>"></script>
    ...
    <div id="floatingButton" class="hidden fixed right-5 bottom-28 z-10 md:right-12 w-10 md:-16 lg:w-12">
        <div class="justify-between w-10 md:w-16 lg:w-12 mx-auto lg:py-3 block lg:mx-0 lg:ml-5">
            <button class="w-full h-full bg-amber-50 shadow-lg rounded-full border border-teal-600/80 hover:bg-amber-100 focus:bg-amber-100 justify-center inline-block text-center pt-2 pb-2 mb-3" data-bs-toggle="modal" data-bs-target="#modalGiftCard">
                <div class="flex">
                    <img class="mx-auto my-auto w-[20px] h-[20px] 2xs:w-[24px] 2xl:h-[24px] 1xs:w-[28px] 1xl:h-[28px] md:w-10 md:h-10 lg:w-[26px] lg:h-[26px]" src="<?= base_url('assets/icons/themes/theme1/floating_gift.svg') ?>" alt="">
                </div>
            </button>
            <button class="w-full bg-amber-50 shadow-lg border border-tema1-pink/80 rounded-full hover:bg-amber-100 focus:bg-amber-100 justify-center inline-block text-center pt-2 pb-2 mb-2">
                <div class="flex">
                    <img class="mx-auto my-auto w-[20px] h-[20px] 2xs:w-[24px] 2xl:h-[24px] 1xs:w-[28px] 1xl:h-[28px] md:w-10 md:h-10 lg:w-[26px] lg:h-[26px] animate-spin-slow" src="<?= base_url('assets/icons/themes/theme1/floating_music_play.svg') ?>" alt="" id="iconMusic">
                </div>
...
<!-- Sampul -->
    <div class="sampul text-center z-0 bg-gradient-to-t from-indigo-100 via-red-100 to-yellow-50  min-h-[100vh] max-h-max" id="sampul">
        <img src="<?= base_url('assets/ilustrations/themes/theme1/sampul_ils1.png')?>" class="absolute opacity-80 w-14 2xs:w-20 sm:w-40">
        ...
        <div class="flex justify-center">
            ...
            <div class="">
                <h1 class="mt-8 2xs:mt-12 sm:mt-14 lg:mt-8 font-KalunaScriptDemo text-3xl 2xs:text-4xl sm:text-6xl lg:text-4xl text-tema1-dark-green">The Wedding Of</h1>

                <div>
                    <div class="flex flex-wrap justify-center mt-8 sm:mt-12 lg:mt-8">
                        <div class="w-32 2xs:w-40 sm:w-60 lg:w-36 px-4">
                            <img src="<?= base_url('assets/img/cover_250x250.png')?>" class="shadow-xl rounded-full max-w-full h-auto align-middle border-b-2" />
                        </div>
                    </div>
                    <div class="flex justify-center opacity-80">
                        <img src="<?= base_url('assets/ilustrations/themes/theme1/sampul_ils2.png')?>" class="-mt-14 2xs:-mt-20 lg:-mt-16 w-40 2xs:w-52 sm:w-64 lg:w-44">
                    </div>
                </div>
                ...
                <div class="flex">
                    <a href="#home" onclick="showMainPage()" id="btnOpen" role="button" class="font-MontserratBold font-medium text-white text-base-xs 2xs:text-sm sm:text-xl lg:text-base-xs w-fit bg-tema1-teal hover:bg-teal-700 rounded-xl sm:rounded-2xl lg:rounded-xl mx-auto transition delay-150 animate-bounce flex justify-center mt-8 mb-8 sm:mt-16 lg:mt-8 px-8 lg:px-8 py-1.5 2xs:py-2.5 sm:py-4 lg:py-1" data-role="link">
                        <div class="flex"> <img src="<?= base_url('assets/icons/cover_icon_unlock.svg') ?>" alt="" class="mr-3 w-3">
                            <p>Buka Undangan</p>
                        </div>
                    </a>
                </div>
        ...
        <img src="<?= base_url('assets/ilustrations/themes/theme1/sampul_ils3.png')?>" class="absolute right-0 opacity-80 -mt-32 sm:-mt-44 lg:bottom-0 w-14 2xs:w-20 sm:w-40">
    </div>
<!-- Sampul End-->
    ...
    <div class="mainPage main-page-transition hidden" id="mainPage">
        ...
        <section class="absolute -z-10 top-0" id="cover">
            ...
            <div class="w-screen h-screen bg-cover bg-center  lg:bg-none lg:bg-violet-200 text-center">
                <div class="flex justify-center ml-5">
                    <div class="lg:w-[50vw] lg:mr-5 lg:h-screen lg:relative absolute bottom-[6vh]" data-aos="zoom-in-down" data-aos-easing="ease-out-cubic" data-aos-duration="500">
                        <div class="flex">
                                <div class="hidden lg:block">
                                    <img src="<?= base_url('assets/ilustrations/themes/theme1/cover_flower1.png')?>" alt="" class="w-40">
                                </div>
                                ...
                                <div class="hidden lg:block">
                                    <img src="<?= base_url('assets/ilustrations/themes/theme1/cover_flower2.png')?>" alt="" class="w-40">
                                </div>
                        </div>
                        <div class="flex">
                                <div class="hidden lg:block absolute bottom-0">
                                    <img src="<?= base_url('assets/ilustrations/themes/theme1/cover_flower5.png')?>" alt="" class="w-20">
                                </div>
                                ...
                                <div class="border border-white/20 w-fit mx-auto px-8 py-2 md:pb-8 lg:py-5 rounded-xl lg:rounded-3xl mt-14 md:mt-24 lg:mt-16 text-pink-100/80 bg-pink-50/10 lg:text-tema1-teal lg:border-tema1-teal/70 lg:bg-tema1-pink/5 font-light font-ShareDong">
                                    <div class=" lg:saturate-150">
                                        <h1 class="text-3xl 2xs:text-4xl sm:text-5xl md:text-6xl lg:text-[40px]" id="days">0</h1>
                                        <p class="md:mt-1 text-base-xs 2xs:text-base-md md:text-[22px] lg:text-md">Hari</p>
                                    </div>
                                    <div class="flex gap-x-4 mt-2 lg:saturate-200">
                                        <div>
                                            <h1 class="text-xl 2xs:text-3xl sm:text-4xl md:text-5xl lg:text-3xl" id="hours">0</h1>
                                            <p class="md:mt-1 text-base-2xs 2xs:text-xs md:text-md lg:text-base-xs">Jam</p>
                                        </div>
                                        <div class="md:text-2xl">|</div>
                                        <div>
                                            <h1 class="text-xl 2xs:text-3xl sm:text-4xl md:text-5xl lg:text-3xl" id="minutes">0</h1>
                                            <p class="md:mt-1 text-base-2xs 2xs:text-xs md:text-md lg:text-base-xs">Menit</p>
                                        </div>
                                        <div class="md:text-2xl">|</div>
                                        <div>
                                            <h1 class="text-xl 2xs:text-3xl sm:text-4xl md:text-5xl lg:text-3xl" id="seconds">0</h1>
                                            <p class="md:mt-1 text-base-2xs 2xs:text-xs md:text-md lg:text-base-xs">Detik</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="hidden lg:block absolute bottom-0 right-0">
                                    <img src="<?= base_url('assets/ilustrations/themes/theme1/cover_flower6.png')?>" alt="" class="w-20">
                                </div>
                        </div>
                    </div>
                    <div class="hidden lg:flex ml-5 w-[50vw] justify-center items-center" data-aos="zoom-in-down" data-aos-easing="ease-out-cubic" data-aos-duration="500">
                        <div> <img src="<?= base_url('assets/ilustrations/themes/theme1/cover_flower4.png')?>" alt="" class="w-20"></div>
                        <div class="shadow-md shadow-tema1-pink rounded-[40px]"><img src="<?= base_url('assets/bg_img/bg_foto_cover_full.jpg')?>" alt="" class="w-96 my-auto border-2 border-tema1-dark-green rounded-[40px]"></div>
                        <div> <img src="<?= base_url('assets/ilustrations/themes/theme1/cover_flower3.png')?>" alt="" class="w-20"></div>
                    </div>
                </div>
            </div>
        ...
        <section class="lg:-mt-5 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-100 via-[#ebeeee] to-[#ebeeee] pb-8 pt-8 lg:pt-0 px-6 1xs:px-16 md:px-24 lg:px-72" id="sambutan">
            <div class="flex justify-center items-center text-center">
                <div class="">
                    <div class="hidden lg:block"><img class="w-24 lg:w-64 absolute -left-3 lg:-left-10 opacity-70" src="<?= base_url('assets/ilustrations/themes/theme1/sambutan_flower1.png')?>" alt=""></div>
                </div>
                <div class="text-base-xs 2xs:text-base-sm 1xs:text-base-md md:text-[26px] lg:text-base lg:leading-6 text-slate-900">
                    <div class="flex" data-aos="zoom-in" data-aos-duration="1000"><img src="<?= base_url('assets/icons/sambutan_bismillah.svg') ?>" class="mx-auto mb-4 md:mb-7 w-[160px] 2xs:w-[180px] 1xs:w-[210px] md:w-[260px] lg:w-[250px]" alt=""></div>
                    ...
                    <div class="flex" data-aos="zoom-in" data-aos-duration="1000">
                        <img src="<?= base_url('assets/img/mempelai_pria_fix.png') ?>" alt="" class="w-[80px] 1xs:w-[120px] lg:w-[130px] xl:w-[140px] mx-auto mt-3 md:mt-8 rounded-full">
                    </div>
                    ...
                    <div class="flex " data-aos="zoom-in" data-aos-duration="1000">
                        <a target="_blank" href="https://www.instagram.com/runvhan/" class="mx-auto my-3 md:my-5 lg:my-3 opacity-70 ho90r:bg-pink-300 hover:opacity-100">
                            <img class="w-5 md:w-8 lg:w-6" src="<?= base_url('assets/icons/sambutan_insta.svg') ?>" alt="">
                        </a>
                    </div>
                    ...
                    <div class="flex" data-aos="zoom-in" data-aos-duration="1000">
                        <img src="<?= base_url('assets/img/mempelai_wanita_fix.png') ?>" alt="" class="mx-auto mt-3 md:mt-8 w-[80px] 1xs:w-[120px] lg:w-[130px] xl:w-[140px]">
                    </div>
                    <div class="text-center font-semibold mt-5 lg:mt-10 font-RadicalsDemo tracking-widest text-2xl 2xs:text-3xl sm:text-4xl md:text-[55px] lg:text-4xl text-tema1-pink" data-aos="zoom-in" data-aos-duration="1000">
                ...
                <div class="">
                    <div class=""><img class="hidden lg:block w-24 lg:w-64 absolute -right-3 lg:-right-10 opacity-70" src="<?= base_url('assets/ilustrations/themes/theme1/sambutan_flower2.png')?>" alt=""></div>
                </div>
            </div>
        </section>
        <!-- Sambutan End -->
        ...
        <section class="-mt-5 bg-gradient-to-t from-violet-200 via-slate-100 to-violet-200 px-6 1xs:px-16 md:px-24 lg:px-8 text-center lg:flex" id="tanggalResepsi">
            <div class="lg:mx-auto">
                <div class="pt-8 lg:pt-28" id="objekResepsi">
                    <!-- Flower Top -->
                    <div class="hidden lg:block">
                        <img class="-mt-32 absolute w-14 md:w-20 lg:w-40 left-14" src="<?= base_url('assets/ilustrations/themes/theme1/resepsi_flower6.svg') ?>" />
                        <img class="-mt-32 absolute w-14 md:w-20 lg:w-40 right-14 rotate-90" src="<?= base_url('assets/ilustrations/themes/theme1/resepsi_flower6.svg') ?>" />
                    </div>
                    <!-- Flower Top -->
                    ...
                    <div class="lg:flex lg:gap-x-6">
                        ...
                        <div class="lg:w-[27vw] mt-5 md:mt-8 items-center border border-tema1-teal/40 shadow-sm shadow-tema1-teal/80 rounded-2xl lg:rounded-3xl bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-100/80 via-[#ebeeee] to-[#f4f5f5]"  data-aos="fade-right" data-aos-delay="500" data-aos-duration="1000">
                            <img class=" absolute w-14 md:w-20 lg:w-14 opacity-80 right-5 1xs:right-16 md:right-24 lg:left-[30vw]" src="<?= base_url('assets/ilustrations/themes/theme1/resepsi_flower2.svg') ?>" />
                        ...
                        <div class="lg:w-[27vw] mt-5 md:mt-8 items-center border border-tema1-teal/40 shadow-sm shadow-tema1-teal/80 rounded-2xl lg:rounded-3xl  bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-100/80 via-[#ebeeee] to-[#f4f5f5]" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
                            <img class=" absolute w-12 md:w-[70px] lg:w-[44px] opacity-80 right-4 1xs:right-14 md:right-[88px] lg:right-[36vw]" src="<?= base_url('assets/ilustrations/themes/theme1/resepsi_flower3.svg') ?>" />
                            <div class="pt-3 pb-5 px-3 md:pt-8 md:pb-8 lg:px-3  font-semibold text-base-xs 2xs:text-base-sm md:text-[26px]  lg:text-base-md text-slate-900/90 tracking-wider">
                        ...
                        <div class="lg:w-[27vw] mt-5 md:mt-8 items-center border border-tema1-teal/40 shadow-sm shadow-tema1-teal/80 rounded-2xl lg:rounded-3xl  bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-100/80 via-[#ebeeee] to-[#f4f5f5]"  data-aos="fade-left" data-aos-delay="500" data-aos-duration="1000">
                            <img class=" absolute w-14 md:w-20 lg:w-14 opacity-80 right-6 1xs:right-16 md:right-24 lg:right-[7.5vw]" src="<?= base_url('assets/ilustrations/themes/theme1/resepsi_flower1.svg') ?>" />
                            <div class="pt-3 pb-5 px-3 md:pt-8 md:pb-8 lg:px-3 font-semibold text-base-xs 2xs:text-base-sm md:text-[26px]  lg:text-base-md text-slate-900/90 tracking-wider">
                ...
                <!-- Flower Bot -->
                <div class="hidden lg:block">
                    <img class="-mt-28 absolute w-14 md:w-20 lg:w-40 left-14 rotate-90" src="<?= base_url('assets/ilustrations/themes/theme1/resepsi_flower7.svg') ?>" />
                    <img class="-mt-28 absolute w-14 md:w-20 lg:w-40 right-14" src="<?= base_url('assets/ilustrations/themes/theme1/resepsi_flower7.svg') ?>" />
                </div>
                <!-- Flower Bot End-->
            </div>
        </section>
        ...
        <section class="-mt-5 md:-mt-10 lg:-mt-20 pb-32 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-100 via-[#ebeeee] to-[#ebeeee]" id="galeriFoto">
            <div class="relative" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500">
                <img class="mx-auto w-[120px] h-[16px] lg:h-[20px] lg:w-[150px] mt-3" src="<?= base_url('assets/bg_img/bg_title_foto.png') ?>" />
            ...
            <div class="border border-tema1-teal/40 shadow-sm shadow-tema1-teal/80 pb-3 md:pb-5 mt-10 lg:pt-10 pt-5 md:pt-8 rounded-2xl lg:rounded-3xl relative bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-100/80 via-[#ebeeee] to-[#f4f5f5] mx-6 1xs:mx-16 md:mx-24  px-4 md:px-8 lg:px-16"  data-aos="zoom-out-left"  data-aos-duration="1000" data-aos-delay="1000">
                ...
                <div class="columns-2 gap-x-2 lg:gap-x-4 md:columns-5xs lg:columns-4xs xl:columns-3xs" id="objekFoto">
                    <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300  aspect-w-5 aspect-h-3  mb-2 xl:mb-3">
                        <img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= base_url('assets/img/foto_1.png') ?>" alt="photo" data-magnify="gallery" data-src="<?= base_url('assets/img/foto_1.png') ?>">
                    </div>
                    <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
                        <img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= base_url('assets/img/foto_2.png') ?>" alt="photo" data-magnify="gallery" data-src="<?= base_url('assets/img/foto_2.png') ?>">
                    </div>
                    <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
                        <img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= base_url('assets/img/foto_3.png') ?>" alt="photo" data-magnify="gallery" data-src="<?= base_url('assets/img/foto_3.png') ?>">
                    </div>
                    <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
                        <img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= base_url('assets/img/foto_4.png') ?>" alt="photo" data-magnify="gallery" data-src="<?= base_url('assets/img/foto_4.png') ?>">
                    </div>
                    <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
                        <img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= base_url('assets/img/foto_5.png') ?>" alt="photo" data-magnify="gallery" data-src="<?= base_url('assets/img/foto_5.png') ?>">
                    </div>
                    <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
                        <img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= base_url('assets/img/foto_6.png') ?>" alt="photo" data-magnify="gallery" data-src="<?= base_url('assets/img/foto_6.png') ?>">
                    </div>
                    <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-4 aspect-h-5 mb-2 xl:mb-3">
                        <img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= base_url('assets/img/foto_7.png') ?>" alt="photo" data-magnify="gallery" data-src="<?= base_url('assets/img/foto_7.png') ?>">
                    </div>
                    <div class="modal-foto-open hover:contrast-50 hover:saturate-200 hover:shadow-xl  transition duration-300 aspect-w-5 aspect-h-3 mb-2 xl:mb-3">
                        <img class="w-full  rounded-2xl view-photo border cursor-pointer hover:border-2 hover:border-blue-400" src="<?= base_url('assets/img/foto_8.png') ?>" alt="photo" data-magnify="gallery" data-src="<?= base_url('assets/img/foto_8.png') ?>">
                    </div>
                </div>
        ...
        <div class="cover-shape -mt-32 lg:-mt-48">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#ead2fc" fill-opacity="1" d="M0,128L48,133.3C96,139,192,149,288,144C384,139,480,117,576,128C672,139,768,181,864,192C960,203,1056,181,1152,176C1248,171,1344,181,1392,186.7L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
        </div>
        ...
        <div class="bg-[#ead2fc] -mt-5 mb-5 lg:pt-0" id="perjalananCinta">
            <div class="">
                <div class="relative" data-aos="zoom-in" data-aos-duration="1000">
                    <img class="mx-auto w-[140px] h-[16px] opacity-80 lg:h-[20px] lg:w-[170px] " src="<?= base_url('assets/bg_img/bg_title_foto.png') ?>" />
                ...
                <div class="absolute right-5 w-16 2xs:w-20 1xs:2-28 sm:w-32 md:-w-36 lg:w-40 xl:hidden">
                    <img src="<?= base_url('assets/ilustrations/themes/theme1/percin_ilus1_sm.svg') ?>" alt="ils percin" data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="500">
                </div>
            </div>
            ...
            <div class="pt-8 mt-10 pb-8 lg:pt-10 relative">
                <div class="xl:flex mx-6 1xs:mx-16 md:mx-24">
                    ...
                    <div class="hidden xl:block" data-aos="zoom-out-down" data-aos-duration="1000">
                        <img src="<?= base_url('assets/ilustrations/themes/theme1/percin_ilus1.svg') ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cover-shape -mt-16 lg:-mt-48">
            <svg xmlns="http://www.w3.org/2000/svg" class="bg-[#f5f1ec]" viewBox="0 0 1440 320"><path fill="#ead2fc" fill-opacity="1" d="M0,192L120,197.3C240,203,480,213,720,213.3C960,213,1200,203,1320,197.3L1440,192L1440,0L1320,0C1200,0,960,0,720,0C480,0,240,0,120,0L0,0Z"></path></svg>
        </div>
        ...
        <section class="bg-[#f5f1ec] -mt-5 lg:-mt-20 lg:pb-12" id="pesanBahagia">
            <div class="relative my-4 lg:my-12 pt-8 lg:pt-0 lg:pb-8" data-aos="zoom-in" data-aos-duration="1000">
                <img class="mx-auto w-[140px] h-[16px] lg:h-[20px] lg:w-[170px]" src="<?= base_url('assets/bg_img/bg_title_foto.png') ?>" />
                    ...
                    <div class="mx-5 flex justify-center">
                        <div class="">
                            <div class="flex w-[180px] lg:w-[250px] mx-auto my-10 opacity-80">
                                <div class="flex mr-5 animate-wiggleLeft"><img src="<?= base_url('assets/ilustrations/themes/theme1/pesan_bahagia_flower_1.svg') ?>" class="w-60 md:w-80 mx-auto mb-4 " alt=""></div>
                                <div class="flex mr-5"><img src="<?= base_url('assets/ilustrations/themes/theme1/pesan_bahagia_flower_2.svg') ?>" class="w-32 mx-auto mb-4" alt=""></div>
                                <div class="flex animate-wiggleRight"><img src="<?= base_url('assets/ilustrations/themes/theme1/pesan_bahagia_flower_3.svg') ?>" class="w-60 md:w-80 mx-auto mb-4" alt=""></div>
                            </div>
                            ...
                            <div class="flex my-10 opacity-80"><img src="<?= base_url('assets/icons/pes_bahagia_flower_thx_bottom.svg') ?>" class="mx-auto mb-4 w-[180px] md:w-[230px] lg:w-[250px]" alt=""></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mb-14 md:mb-20 flex justify-center items-center">
            <div class="flex ml-3 text-base-1xs 2xs:text-base-xs 1xs:text-base-sm md:text-[22px] lg:text-base">
                <div class="flex justify-center items-center w-1/2 mr-5">
                    <div class="">
                        <img src="<?= base_url('assets/icons/logo_metashare.png') ?>" class="mr-3 w-[100px] md:w-36" alt="Flowbite Logo">
                ...
                <div class="flex justify-center items-center w-1/2 ml-5">
                    <a target="_blank" href="https://api.whatsapp.com/send/?phone=6287899703471&text=Saya tertarik untuk bikin undangan" class="flex hover:contrast-200 hover:saturate-200 hover:text-green-400">
                        <img src="<?= base_url('assets/icons/wa.png') ?>" class="mr-1 h-3 2xs:h-4 md:h-6 md:mt-1 lg:h-5 lg:mt-0" alt="Whatsapp Logo">
    ...
    id="modalGiftCard" tabindex="-1" aria-labelledby="modalGiftCardLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable relative w-auto pointer-events-none">
        <div
        class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-[#f4f4f4] bg-clip-padding rounded-md outline-none text-current">
        <!-- Notif Success Copy-->
        ...
        <div
            class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-tema1-teal/30 rounded-t-md">
        ...
        <div class="modal-body relative p-4">
            ...
            <div class="rounded-lg p-4 my-5 tracking-widest shadow-md shadow-tema1-teal/10 border border-tema1-teal/40">
                <div class="px-2 py-3">
                    <div class=""><img class="h-5" src="<?= base_url('assets/icons/themes/theme1/i_gift_card_va_bca.svg') ?>" alt="bca"></div>
                    <div class="flex mt-4">
                        <div>
                        ...
                        <button class="hover:shadow-lg focus:shadow-xl active:shadow-xl transition duration-100 ease-in-out"><img class="h-3 2xs:h-4" src="<?= base_url('assets/icons/themes/theme1/copy.svg') ?>" alt="Copy" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Salin" onclick="CopyToClipboard('noBca'); return false;"></button>
                    </div>
                    <div>
            ...
            <div class="rounded-lg p-4 my-5 tracking-widest shadow-md shadow-tema1-teal/10 border border-tema1-teal/40">
                <div class="px-2 py-3">
                    <div class=""><img class="h-5" src="<?= base_url('assets/icons/themes/theme1/i_gift_card_va_bri.svg') ?>" alt="bri"></div>
                    <div class="flex mt-4">
                        <div>
                        ...
                        <button class="hover:shadow-lg focus:shadow-xl active:shadow-xl transition duration-100 ease-in-out"><img class="h-3 2xs:h-4" src="<?= base_url('assets/icons/themes/theme1/copy.svg') ?>" alt="Copy" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Salin" onclick="CopyToClipboard('noBri'); return false;"></button>
                    </div>
                    <div>
                        <p class="text-base-1xs 2xs:text-base-xs 1xs:text-base-sm md:text-[16px] lg:text-[15px] lg:leading-6 font-normal text-slate-600">a.n. <span class="text-slate-900">Runa Vha Ningit </span></p>
                    </div>
            ...
            <!-- content card bri end-->
                   ...
                   <div class="rounded-lg p-4 my-5 tracking-widest shadow-md shadow-tema1-teal/10 border border-tema1-teal/40">
                <div class="px-2 py-3">
                    <div class=""><img class="h-5" src="<?= base_url('assets/icons/themes/theme1/i_gift_card_va_mandiri.svg') ?>" alt="mandiri"></div>
                    <div class="flex mt-4">
                        <div>
                        ...
                        <button class="hover:shadow-lg focus:shadow-xl active:shadow-xl transition duration-100 ease-in-out"><img class="h-3 2xs:h-4" src="<?= base_url('assets/icons/themes/theme1/copy.svg') ?>" alt="Copy" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Salin" onclick="CopyToClipboard('noMandiri'); return false;"></button>
                    </div>
                    <div>
                        <p class="text-base-1xs 2xs:text-base-xs 1xs:text-base-sm md:text-[16px] lg:text-[15px] lg:leading-6 font-normal text-slate-600">a.n. <span class="text-slate-900">Runa Vha Ningit </span></p>
                    </div>
            ...
            <div class="rounded-lg p-4 my-5 tracking-widest shadow-md shadow-tema1-teal/10 border border-tema1-teal/40">
                    <div class="px-2 py-3">
                        <div class=""><img class="h-5" src="<?= base_url('assets/icons/themes/theme1/i_gift_card_va_bsi.svg') ?>" alt="bsi"></div>
                        <div class="flex mt-4">
                            <div>
                            ...
                            <button class="hover:shadow-lg focus:shadow-xl active:shadow-xl transition duration-100 ease-in-out"><img class="h-3 2xs:h-4" src="<?= base_url('assets/icons/themes/theme1/copy.svg') ?>" alt="Copy" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Salin" onclick="CopyToClipboard('noBsi'); return false;"></button>
                        </div>
                        <div>
                            <p class="text-base-1xs 2xs:text-base-xs 1xs:text-base-sm md:text-[16px] lg:text-[15px] lg:leading-6 font-normal text-slate-600">a.n. <span class="text-slate-900">Runa Vha Ningit </span></p>
                        </div>
            ...
            <div class="rounded-lg p-4 my-5 tracking-widest shadow-md shadow-tema1-teal/10 border border-tema1-teal/40">
            <div class="px-2 py-3">
                <div class=""><img class="h-5" src="<?= base_url('assets/icons/themes/theme1/i_gift_card_va_bni.svg') ?>" alt="bni"></div>
                <div class="flex mt-4">
                    <div>
                    ...
                    <button class="hover:shadow-lg focus:shadow-xl active:shadow-xl transition duration-100 ease-in-out"><img class="h-3 2xs:h-4" src="<?= base_url('assets/icons/themes/theme1/copy.svg') ?>" alt="Copy" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Salin" onclick="CopyToClipboard('noBni'); return false;"></button>
                </div>
                <div>
                    <p class="text-base-1xs 2xs:text-base-xs 1xs:text-base-sm md:text-[16px] lg:text-[15px] lg:leading-6 font-normal text-slate-600">a.n. <span class="text-slate-900">Runa Vha Ningit </span></p>
                </div>
            ...
            <div class="rounded-lg p-4 my-5 tracking-widest shadow-md shadow-tema1-teal/10 border border-tema1-teal/40">
                <div class="px-2 py-3">
                    <div class=""><img class="h-5" src="<?= base_url('assets/icons/themes/theme1/i_gift_card_va_cimbniaga.svg') ?>" alt="cimbniaga"></div>
                    <div class="flex mt-4">
                        <div>
                        ...
                        <button class="hover:shadow-lg focus:shadow-xl active:shadow-xl transition duration-100 ease-in-out"><img class="h-3 2xs:h-4" src="<?= base_url('assets/icons/themes/theme1/copy.svg') ?>" alt="Copy" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Salin" onclick="CopyToClipboard('noCimbniaga'); return false;"></button>
                    </div>
                    <div>
                        <p class="text-base-1xs 2xs:text-base-xs 1xs:text-base-sm md:text-[16px] lg:text-[15px] lg:leading-6 font-normal text-slate-600">a.n. <span class="text-slate-900">Runa Vha Ningit </span></p>
                    </div>
            ...
            <div class="rounded-lg p-4 my-5 tracking-widest shadow-md shadow-tema1-teal/10 border border-tema1-teal/40">
            <div class="px-2 py-3">
                <div class=""><img class="h-5" src="<?= base_url('assets/icons/themes/theme1/i_gift_card_va_dana.svg') ?>" alt="dana"></div>
                <div class="flex mt-4">
                    <div>
                    ...
                    <button class="hover:shadow-lg focus:shadow-xl active:shadow-xl transition duration-100 ease-in-out"><img class="h-3 2xs:h-4" src="<?= base_url('assets/icons/themes/theme1/copy.svg') ?>" alt="Copy" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Salin" onclick="CopyToClipboard('noDana'); return false;"></button>
                </div>
                <div>
                    <p class="text-base-1xs 2xs:text-base-xs 1xs:text-base-sm md:text-[16px] lg:text-[15px] lg:leading-6 font-normal text-slate-600">a.n. <span class="text-slate-900">Runa Vha Ningit </span></p>
                </div>
        ...
        <div class="modal-footer flex flex-shrink-0 flex-wrap items-center justify-center p-4 border-t border-tema1-teal/30 rounded-b-md">
                <button type="button"
                class="px-4 py-1 md:px-8 md:py-3 lg:py-1.5 lg:px-6 bg-tema1-pink/70 hover:bg-tema1-pink/100  text-white rounded-lg hover:bg-opacity-70 transition-all duration-300 text-sm 2xs:text-base-sm 1xs:text-base md:text-[27px] lg:text-base lg:leading-6 font-semibold"
...
<script>
    ...
    iconMusic.onclick = function() {
        if (song.paused) {
            song.play();
            iconMusic.src = "<?= base_url('assets/icons/themes/theme1/floating_music_play.svg') ?>"
            iconMusic.classList.add('animate-spin-slow')
        } else {
            song.pause();
            iconMusic.src = "<?= base_url('assets/icons/themes/theme1/floating_music_paused.svg') ?>"
