...
<section>
    <div class="xl:border xl:border-slate-600/20 xl:shadow xl:bg-white xl:rounded-xl xl:px-10 xl:py-8">
        ...
        <h1 class="text-base xl:text-lg font-MontserratBold mb-4">Kategori Special</h1>                  
                ...
                <div class="cover-image border border-slate-400/30 rounded-2xl flex justify-center mb-6 px-4">
                    <div class="">
                        ...
                        <div class="my-3">
                            ...
                            <p class="text-base-xs xl:text-xs text-slate-400">Undangan Pernikahan Digital/Special</p>
                        </div>
