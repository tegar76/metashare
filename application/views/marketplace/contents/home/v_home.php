<section>
    ...
    <div class="xl:items-center md:flex">
        <div class="lg:w-[60%] xl:w-[60%] md:pr-12 lg:pr-18 xl:pr-24">
            <h1 class="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-Montserrat font-extrabold text-center md:text-left">Hallo, <p>Selamat Datang!</p></h1>
            <div class="flex mt-5">
                                    ...
                                    <div class="cover-image w-[80vw] 1xs:w-full rounded-2xl flex justify-center border border-slate-600/60 shadow bg-white md:border-slate-600/40 md:shadow-none md:bg-none">
                                        ...
                                        <div id="carouselCoverSpecial<?=$card_category?>" class="carousel slide relative" data-bs-ride="carousel">
                                            ...
                                            <div class="carousel-item active float-left w-full rounded-xl shadow-xl">
                                                <img src="<?= base_url('storage/model_undangan_sampul/sampul_b.svg')?>" class=" block w-[270px] h-[378px] object-cover rounded-xl border border-slate-600 md:border-slate-600/30" alt="Sampul"/>
                                            </div>
                                            <div class="carousel-item float-left w-full rounded-xl shadow-xl">
                                                <img src="<?= base_url('storage/model_undangan_cover/cover_a.svg')?>" class=" block w-[270px] h-[378px] object-cover  rounded-xl border border-slate-600 md:border-slate-600/30" alt="Sampul"/>
                                            </div>
                                            </div>
                                        ...
                                        <div class="my-3 text-center lg:text-left">
                                            ...
                                            <p class="text-base-1xs xl:text-base-xs opacity-80">Undangan Pernikahan Digital/Special</p>
                                        </div>
                                        <div class="flex mb-4 justify-center">
                                            <a target="_blank" href="<?= base_url('PreviewUndangan/demo')?>" class="text-base-xs xl:text-sm border text-primary-blue-cyan/90 border-primary-blue-cyan/70 px-3 py-1 rounded-lg hover:bg-primary-blue-cyan hover:text-white hover:border-white mr-3"> <i class="fa fa-eye"></i> Demo</a>
                            ...
                            <div>
                                <div class="cover-image w-[80vw] 1xs:w-full rounded-2xl flex justify-center border border-slate-600/60 shadow bg-white md:border-slate-600/40 md:shadow-none md:bg-none">
                                    ...
                                    <div id="carouselCoverStandard<?=$card_category?>" class="carousel slide relative" data-bs-ride="carousel">
                                        ...
                                        <div class=" carousel-inner relative w-full overflow-hidden">
                                        <div class="carousel-item active float-left w-full rounded-xl shadow-xl">
                                            <img src="<?= base_url('storage/model_undangan_sampul/sampul_b.svg')?>" class=" block w-[270px] h-[378px]  object-cover  border border-slate-600 md:border-slate-600/30 rounded-xl" alt="Sampul"/>
                                        </div>
                                        <div class="carousel-item float-left w-full">
                                            <img src="<?= base_url('storage/model_undangan_cover/cover_a.svg')?>" class=" block w-[270px] h-[378px]  object-cover  border border-slate-600 md:border-slate-600/30 rounded-xl " alt="Sampul"/>
                                        </div>
                                        </div>
                                        <!-- <div class="button-actions absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"  id="button-actions<?=$card_category?>">
                                        <div><button>kfdldnf</button></div>
                                    ...
                                    <div class="my-3 text-center lg:text-left">
                                        <h1 class="text-base-xs xl:text-base font-semibold opacity-90">Flower Flying <?=$card_category?></h1>
                                        <p class="text-base-1xs xl:text-base-xs opacity-80">Undangan Pernikahan Digital/Standard</p>
                                    </div>
                                    <div class="flex mb-4 justify-center">
                                        <a target="_blank" href="<?= base_url('PreviewUndangan/demo')?>" class="text-base-xs xl:text-sm border text-primary-blue-cyan/90 border-primary-blue-cyan/70 px-3 py-1 rounded-lg hover:bg-primary-blue-cyan hover:text-white hover:border-white mr-3"> <i class="fa fa-eye"></i> Demo</a>
                                        <a href="" class="text-base-xs xl:text-sm border text-white border-success bg-success px-3 py-1 rounded-lg hover:bg-success-hover hover:border-success-hover hover:text-white"> <i class="fa-brands fa-whatsapp fa-lg"></i> Order</a>
                        ...
                        <div class="relative">
                            ...
                            <div>
                                <div class="cover-image w-[80vw] 1xs:w-full rounded-2xl flex justify-center border border-slate-600/60 shadow bg-white md:border-slate-600/40 md:shadow-none md:bg-none">
                                    ...
                                    <div class="my-3 text-center lg:text-left">
                                        <h1 class="text-base-xs xl:text-base font-semibold opacity-90">Flower Flying <?=$card_category?></h1>
                                        <p class="text-base-1xs xl:text-base-xs opacity-80">Undangan Pernikahan Digital/Basic</p>
                                    </div>
                                    <div class="flex mb-4 justify-center">
                                        <a target="_blank" href="<?= base_url('PreviewUndangan/demo')?>" class="text-base-xs xl:text-sm border text-primary-blue-cyan/90 border-primary-blue-cyan/70 px-3 py-1 rounded-lg hover:bg-primary-blue-cyan hover:text-white hover:border-white mr-3"> <i class="fa fa-eye"></i> Demo</a>
                                        <a href="" class="text-base-xs xl:text-sm border text-white border-success bg-success px-3 py-1 rounded-lg hover:bg-success-hover hover:border-success-hover hover:text-white"> <i class="fa-brands fa-whatsapp fa-lg"></i> Order</a>
