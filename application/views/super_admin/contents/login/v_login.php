            ...
            <div class="auth-box row bg-white shadow-sm w-md-75 w-lg-50">
                ...
                <div class="col-lg-6 col-md-7 mt-2">
                    <div class="p-3">
                        ...
                        <form class="mt-4" action="<?= base_url('SuperAdmin/Dashboard')?>">
                            <div class="row">
                                <div class="col-lg-12 mb-1">
                                    <div class="form-group">
                                        <div class="input-group rounded shadow-sm">
                                            <span><label for="username" class="far fa-regular fa-user mt-2 pl-3 text-primary"></label></span>
                                            <input class="form-control border-0" id="username" type="text" placeholder="Masukan Username">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-1">
                                    <div class="form-group">
                                        <div class="input-group rounded shadow-sm">
                                            ...
                                            <input class="form-control border-0" id="password" type="password" placeholder="Masukan password" autocomplete="current-password" id="id_password"><span role="button" class="d-flex"><i class="fas fa-eye fa-xs mr-2 my-auto" id="togglePassword"></i></span>
                                        </div>
                                    </div>
                                </div>
