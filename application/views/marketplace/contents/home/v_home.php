<section>
	<div class="xl:hidden flex justify-end my-3">
		<?php if ($this->session->userdata('logged_in') == false) : ?>
			<!-- Signup -->
			<a href="<?= base_url('register') ?>" class="xs:text-base-1xs lg:text-sm rounded-3xl border-slate-300 bg-danger border rounded-lg hover:bg-danger-hover text-white py-1">
