            ...
            <div class="container-fluid">
                <div class="card shadow px-5 py-3">
                    ...
                    <div class="form-group col-4 mt-4">
                        <div class="input-group mb-2 ml-n4">
                    ...
                    <div class="row">
                        <!-- Item Model -->
                        <div class="card shadow-sm card-sampul-cover p-2 mr-4 mb-4">
                            ...
                            <p>Undangan Pernikahan Digital / Special</p>
                            <div>
                                <a target="_blank" href="<?= base_url('PreviewUndangan/demo')?>" class="btn btn-sm btn-outline-info text-sm  px-2 mr-3">
